...
Save: Raw
   ...
   shows the construction of image writer, and saves a single RAW image.
'''
...
def save(buffer):
	'''
	demonstrates saving a RAW image
	...
	writer = Writer()
	writer.pattern = 'images/py_save_writer_raw/image_<count>.raw'
	''' 
