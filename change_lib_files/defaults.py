...
class DefaultPredictor:
    ...
    def __call__(self, original_image):
        ...
        with torch.no_grad():  # https://github.com/sphinx-doc/sphinx/issues/4258
            ...
            ### 추가 ###   
            # 상위 2개의 인덱스 가져오기
            topk_values, topk_indices = torch.topk(predictions["instances"].scores, k=2)
            # 해당 인덱스를 이용해 새로운 Instances 객체 생성
            predictions["instances"] = predictions["instances"][topk_indices]
