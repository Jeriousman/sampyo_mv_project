...
def move_abspantilt(ptz, pan, tilt, requesta, velocity=0.5):
...
def continuous_move():
    ...
    while True:
        action = input("Enter the action ('u', 'd', 'l', 'r', 'zi', 'zo','m', 's' or 'q'): ").strip().lower()
        ...
        if action == "u":
            ...
            print("Invalid action. Please enter 'u', 'd', 'l', 'r', 'zi', 'zo','m', 's' or 'q'.")
